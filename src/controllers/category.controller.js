...
exports.create = async (req, res) => {
  ...
  try {
    ...
    logger.log("POST", "/category/create", currentuser, err, false);
    return res.status(httpStatus.INTERNAL_SERVER_ERROR).send({ data: {}, errors: [errorCode.ERR0000, err.message] });
  }
};
...
exports.createProductOrService = async (req, res) => {
  ...
  try {
    ...
    logger.log(
      "POST",
      "/category/create-product-or-service",
      currentuser,
      err,
      false
    );
...
exports.quitProductOrService = async (req, res) => {
  ...
  try {
    ...
    logger.log(
      "POST",
      "/category/quit-product-or-service",
      currentuser,
      err,
      false
    );
